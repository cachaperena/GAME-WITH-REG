...
function finalScore() {
    ...
    switch (score) {
        case 1:
            ...
            $statement.text(`You made it in ${seconds - 1} seconds with ${moves} moves and the score of ONLY ${score} star. YOU WON! You can get your prizes when you click it below!`);
            $congrats.text('CONGRATULATIONS!');
            break;
        case 2:
            $starsInModal.append($twoStars);
            $statement.text(`You made it in ${seconds -1} seconds with ${moves} moves and the score of ${score} stars. YOU WON! You can get your prizes when you click it below!`);
            $congrats.text('CONGRATULATIONS!');
            break;
        case 3:
